...
public abstract class KKByteArrayAPIBase extends APIBase {

	private KKByteArrayAPIRequestListener apiRequestListener = new KKByteArrayAPIRequestListener() {
		@Override
		...
		@Override
		public void onPreComplete(byte[] data) {
	...
	protected abstract int parse(byte[] data);
}
