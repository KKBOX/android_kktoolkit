...
public class KKListView extends ListView {
	...
	public void setPullToRefresh(OnRefreshListener onRefreshListener) {
		...
		refreshHeaderhViewOriginHeight = (int)(60 * getContext().getResources().getDisplayMetrics().density);
		addHeaderView(headerView, null, false);
		String lastUpdatedTime = (String)this.getResources().getText(R.string.last_update) + " "
