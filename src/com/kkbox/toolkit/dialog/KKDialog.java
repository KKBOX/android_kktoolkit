...
public class KKDialog extends DialogFragment {
    ...
    private boolean blockBackEnabled = false;
    public KKDialog() {
    }
    ...
    public void enabledBlockBackKey(boolean enabled) {
        this.blockBackEnabled = enabled;
    }
    ...
    public void onResume() {
        ...
        getDialog().setOnKeyListener(new DialogInterface.OnKeyListener() {
            ...
            public boolean onKey(DialogInterface dialogInterface, int keyCode, KeyEvent keyEvent) {
                if (blockBackEnabled && keyCode == KeyEvent.KEYCODE_BACK) {
                    return true;
                }
                return false;
            }
